...
<div class="jumbotron text-center" style="margin-bottom:20px; background-color: #9E1B32; color: #fff;">
  <h1>Student Attendance System</h1>
</div>
<div class="container">
	<div class="row">
		<div class="col-md-7">
			<img src = "student_image/logo.jpg" alt="Logo" href= "logo.jpg" height="100%" />
		</div>
		<div class="col-md-5" style="margin-top: 20px;">
			<div class="card" style="background-color: ;">
				<div class="card-header" style="background-color: #20B2AA; color: #fff;">Admin Login</div>
				<div class="card-body">
					<form method="post" id="admin_login_form">
						...
						<div class="form-group">
							<input type="submit" name="admin_login" id="admin_login" class="btn" style="background-color: #20B2AA; color: #fff;" value= "LOGIN" />
						</div>
					</form>
				</div>
			</div>
